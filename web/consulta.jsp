<%-- 
    Document   : consulta
    Created on : 21/07/2021, 07:18:19 AM
    Author     : Juan Ayala
--%>
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body>
    <marquee><h1>Consulta Pacientes JSP AYALA </h1></marquee>
    <center><h1>Suistema Control JSP-WEB</h1></center>
    <hr>
...
<%
                       ...
                       <a href="baja.html"><h4>Elimina Pacientes</h4></a>
                   </center>    
               </div>
           </div>
       </div>
